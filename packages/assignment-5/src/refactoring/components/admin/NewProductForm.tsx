    ...
    <div className="bg-white p-4 rounded shadow mb-4">
      ...
      <div className="mb-2">
        ...
        <input
          ...
          onChange={(e: ChangeEvent<HTMLInputElement>) => editProperty('price', e.target.valueAsNumber)}
          className="w-full p-2 border rounded"
        />
      </div>
      <div className="mb-2">
      ...
      <button onClick={submit} className="w-full bg-blue-500 text-white p-2 rounded hover:bg-blue-600">
        추가
      </button>
    </div>
  );
